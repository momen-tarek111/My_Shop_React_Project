...
const Slider = ({data}) => {
  ...
  return (
    <div className='slider-container'>
        <button disabled={slideIndex===-data.length+1} onClick={()=>{handleClick("left")}} className="bi bi-chevron-left arrow-left"></button>
        <div style={{transform:`translate(${slideIndex*-280}px)`}} className="slider-wrapper">
            {
                data.map(item=>
